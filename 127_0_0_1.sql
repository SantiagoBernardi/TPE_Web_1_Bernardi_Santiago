...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2022 a las 00:47:04
...
--
CREATE DATABASE IF NOT EXISTS `bd_anuros` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_anuros`;
...
INSERT INTO `usuarios` (`id_u`, `user`, `password`) VALUES
(1, 'admin', '$2y$10$dTOyKF9BtrwIVMFqxpx0wOe9znym3aygH1QnHYqVaTNcSCN.pdbKu');
...
('root', '[{\"db\":\"bd_usuarios\",\"table\":\"usuarios\"},{\"db\":\"bd_anuros\",\"table\":\"anuros\"},{\"db\":\"bd_anuros\",\"table\":\"ecosistemas\"},{\"db\":\"bd_anuros\",\"table\":\"familias\"}]');
...
('root', 'bd_anuros', 'anuros', '{\"sorted_col\":\"`anuros`.`id_ecosistema_fk` DESC\"}', '2022-10-13 20:42:29');
...
('root', '2022-10-16 21:05:16', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
